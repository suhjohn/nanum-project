    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facebook_user_id', models.CharField(blank=True, max_length=200, verbose_name='facebook user id')),
                ('user_type', models.CharField(choices=[('FB', 'Facebook'), ('EM', 'Email')], default='EM', max_length=2)),
